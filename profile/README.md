...
| :-------------: | :-----------------------------: | :---------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------: |
| [Init-Venv](https://github.com/Dev2Forge/Init-Venv) | [Releases](https://github.com/Dev2Forge/Init-Venv/releases/) | _Not available on Pypi_ | [![SourceForge Downloads](https://img.shields.io/sourceforge/dt/Init-Venv.svg)](https://sourceforge.net/projects/bridgex/files/latest/download)|
| [bridgex](https://github.com/Dev2Forge/bridgex) | `pip install bridgex` | [![PyPI Downloads](https://static.pepy.tech/badge/bridgex)](https://pepy.tech/projects/bridgex)         | [![SourceForge Downloads](https://img.shields.io/sourceforge/dt/bridgex.svg)](https://sourceforge.net/projects/bridgex/files/latest/download)|
